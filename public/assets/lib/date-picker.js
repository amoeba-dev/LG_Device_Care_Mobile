...
function datePickHandler() {
    ...
    $(document)
        ...
        .on("keydown", function (e) {
            if (e.key === "Tab" && $("#ui-datepicker-div").is(":visible")) {
                const $focusEl = $("*:focus");
                const $focus = $($focusEl[0]);
                e.preventDefault();
                if (!$focusEl.length) {
                ...
                if (e.shiftKey) {
                    ...
                    if ($focus.hasClass("ui-datepicker-close")) {
                        let activeDate = $(".ui-state-highlight")[0] || $(".ui-state-active")[0];
                        if (activeDate) {
                            activeDate.focus();
                        } else {
                    ...
                    if ($focus.hasClass("ui-datepicker-next")) {
                        $(".ui-datepicker-prev")[0].focus();
                    }
                    if ($focus.hasClass("ui-datepicker-prev")) {
    ...
    $(container).on("keydown", function calendarKeyboardListener(keyVent) {
        ...
        if (27 === which) {
            ...
            // if ($(target).hasClass("ui-datepicker-close")) {
            //     // close button
            // activeDate = $(".ui-state-highlight")[0] || $(".ui-state-active")[0];
            // if (activeDate) {
            //     activeDate.focus();
            // } else {
            //     $(".ui-state-default")[0].focus();
